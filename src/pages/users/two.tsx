...
export default function UsersTwo({data}: InferGetStaticPropsType<typeof getStaticProps>) {
      ...
      <div className='users-page'>
        ...
        <div className='users-details-container'>
          ...
          <div className='user-details-head'>
            {data.slice(15, 30).map(({id, userName, email, phoneNumber, createdAt, lastActiveDate}: any) => (
...
UsersTwo.getLayout = function getLayout(page: ReactElement) {
    return (
        <Layout>
          {page}
        </Layout>
