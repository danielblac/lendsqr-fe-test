...
export default function UsersSix({data}: InferGetStaticPropsType<typeof getStaticProps>) {
      ...
      <div className='users-page'>
        ...
        <div className='users-details-container'>
          ...
          <div className='user-details-head'>
            {data.slice(75, 90).map(({id, userName, email, phoneNumber, createdAt, lastActiveDate}: any) => (
...
UsersSix.getLayout = function getLayout(page: ReactElement) {
    return (
        <Layout>
          {page}
        </Layout>
