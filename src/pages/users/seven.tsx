...
export default function UsersSeven({data}: InferGetStaticPropsType<typeof getStaticProps>) {
        ...
        <div className='users-details-container'>
          <div>
            ...
            <div className='user-details-head'>
              {data.slice(90, 100).map(({id, userName, email, phoneNumber, createdAt, lastActiveDate}: any) => (
...
UsersSeven.getLayout = function getLayout(page: ReactElement) {
    return (
        <Layout>
          {page}
        </Layout>
